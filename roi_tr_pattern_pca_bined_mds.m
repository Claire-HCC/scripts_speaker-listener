...
for ei=3%1:2;
    ...
    for rii=1:length(ris);
        ...
        if exist([fl '.mat'])>0;
            ...
            if size(gdata2,1)>10 & size(data2,1)>10;
                timeN=size(gdata2,2);
                subjN=size(gdata2,3);
                ...
                save([expdir '/' exp '/fmri/' rname '_tr_pattern_binSize' num2str(binSize) '_test_metric_mds_' type '_' col_speaker '_2d.mat'],'speaker_cord','listener_cord','binN','binSize','binStep','rname')
