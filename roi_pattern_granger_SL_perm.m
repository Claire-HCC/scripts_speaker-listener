function roi_tr_pattern_granger_SL_perm(perm)
...
for ei=2;%[3 4 2];%1:2;
    ...
    for lagi=3;%1:length(lags_tested);
        ...
        save([expdir '/' exp '/fmri/pattern_regression/' timeUnit '/roi/' froidir '/perm/granger_SL_lag' num2str(min(lags)) '-' num2str(max(lags)) '_perm' num2str(perm)],'F_s2l','r2_s','r2_l','r2_ls','lags','rnames','keptT',...
            'r2_l_byTime','r2_ls_byTime','r2_s_byTime');
          clear F_s2l F_l2l r2_s r2_l r2_ls r2_l_byTime r2_ls_byTime r2_s_byTime
    end
end
