...
for ei=[2 4 11 12 9 10 13];
        ...
        for tgi=1:6;
            ...
            for fi=1:2;
                ...
                for si=1:listenerN;
                    ...
                    y=zscore(gdata_targetf(:,keptT,si),0,2);
    ...
    save([expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/network2networks/' froidir '/LL_selfself/networks2networks_filtered'  ],'r','networks','keptT','filtertypes');
end
%
%
% nis=[2     4     1     5     3     6];
...
%         ei=eis(eii);
%         exp=experiments{ei};
%         % load([expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/network2networks/' froidir '/LL_selfself/networks2networks_filtered'  ],'r','networks','keptT','filtertypes');
