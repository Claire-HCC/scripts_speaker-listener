...
lags_tested={-10:10 -10:-4, -20:-4, -30:-4, -10:-1};
...
for ei=1:4;
    ...
    for binSizei=1:length(binSize_tested);
        ...
        for lagi=1:length(lags_tested);
            ...
            save([expdir '/' exp '/fmri/pattern_regression_bined/' timeUnit '/roi/' froidir '/SLg/regression_SL_binSize' num2str(binSize) '_lag' num2str(min(lags)) '-' num2str(max(lags)) ],'b','F','r2','p','lags','rnames','binSize');
            clear b F p r2
        end
    end
end
