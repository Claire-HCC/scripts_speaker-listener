...
for ei=1:4;
    ...
    for lagi=1%:length(lags_tested);
        ...
        load([expdir '/' exp '/fmri/pattern_lagcorr/' timeUnit '/roi/' froidir '/SLg/SL_lag' num2str(min(lags)) '-' num2str(max(lags)) '_peaks' ],'rnames','r','lags','p','p_fdr','peakLags_pfdr','onsetsOrder','peak','peakLags_pfdr');
