...
for ei=1:10;
    ...
    for lagi=3%:length(lags_tested);
        ...
        for ri=1;
            ...
            save([expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/roi2vox/' froidir '/LL_leave1out/' roi '2voxIsc' num2str(perc*100) 'PercMasked_lag' num2str(min(lags)) '-' num2str(max(lags)) '_timeReversed_peaks' ],...
