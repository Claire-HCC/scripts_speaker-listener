...
data_mat=scipy.io.loadmat(expdir + '/' + exp + '/fmri/timeseries/' + timeUnit + '/roi/' + froidir + '/zscore_speaker_'+ rname + '.mat')
data=data_mat['data']

data_mat=scipy.io.loadmat(expdir + '/' + exp + '/fmri/timeseries/' + timeUnit + '/roi/' + froidir + '/zscore_listenerAll_' +rname+ '.mat')
