function roi2rois_temporal_circularlagcorr_LL_leave1out(sdi)
...
for ei=13;%[1 2 4 9:12]
    ...
    mkdir([expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/roi2rois/' froidir '/LL_leave1out/']);
    ...
    if exist([expdir '/' exp '/fmri/timeseries/' timeUnit '/roi/' froidir '/listenerAll_' seed '.mat' ]);
        ...
        save([expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/roi2rois/' froidir '/LL_leave1out/' seed ],'r','lags','rnames','keptT');
        clear r
    end
end
