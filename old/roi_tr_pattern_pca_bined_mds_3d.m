...
for ei=2%1:2;
    ...
    for rii=1:length(ris);
        ...
        if exist([fl '.mat'])>0;
            ...
            [coeff,score,latent,tsquared,explained,mu] = pca(mean(gdata,3));
            [coeff2,score2,latent2,tsquared2,explained2,mu2] = pca(mean(gdata,3));
            ...
            if size(gdata,1)>10 & size(data,1)>10;
                ...
                save([expdir '/' exp '/fmri/' rname '_tr_pattern_binSize' num2str(binSize) '_metric_mds_' type '_' col_speaker '_3d.mat'],'speaker_cord','listener_cord','binN','binSize','binStep','rname')
