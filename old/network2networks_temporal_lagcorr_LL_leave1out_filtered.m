...
for ei=[13 ];%[1 4 11 12 9 10];
        ...
        for tgi=1:6;
            ...
            for fi=1:2;
                ...
                for si=1:listenerN;
                    ...
                    r(sdi,tgi,:,fi,si)=lagcorr(x,y,lags)';
    ...
    save([expdir '/' exp '/fmri/temporal/lagcorr/' timeUnit '/network2networks/' froidir '/LL_leave1out/networks2networks_filtered' '_cutoff'  strrep(num2str(cutoff),'0.','')  ],'cutoff','r','networks','keptT','filtertypes','gdataf');
end
