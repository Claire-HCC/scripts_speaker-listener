...
for ei=[1:4];%[1:4];;%
    ...
    for lagi=1%:length(lags_tested);
        ...
        load([expdir '/' exp '/fmri/pattern_regression/' timeUnit '/roi/' froidir '/SLeach/regression_SLeach_lag' num2str(min(lags)) '-' num2str(max(lags)) '_classification' ],'rnames','b_s','b_l','bPeakLags');
       % sig_betaClass=p_fdr<.05;
