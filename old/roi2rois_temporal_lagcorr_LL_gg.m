function roi2rois_temporal_lagcorr_LL_gg
...
for ei=3;%1:4;
    exp=experiments{ei};
    %  rmdir([expdir '/' exp '/fmri/temporal/lagcorr/' timeUnit '/roi2rois/' froidir '/LL_gg/perm/'],'s');
    mkdir([expdir '/' exp '/fmri/temporal/lagcorr/' timeUnit '/roi2rois/' froidir '/LL_gg/perm/']);
    ...
    for lagi=1%:length(lags_tested);
        ...
        for sdi=2;%1:length(seeds);
            ...
            save([expdir '/' exp '/fmri/temporal/lagcorr/' timeUnit '/roi2rois/' froidir '/LL_gg/' seed '_lag' num2str(min(lags)) '-' num2str(max(lags)) ],'r','lags','rnames','keptT');
            clear r
        end
    end
end
