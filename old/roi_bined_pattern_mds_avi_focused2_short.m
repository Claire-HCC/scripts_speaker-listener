...
for ei=1;%1:2;
    ...
    for rii=1:length(ris);
        ...
        for ti=tr_s:binStep:tr_e;
            ...
            xlim(listenerM_cord(1)+[-1.5 1.5]);
            ylim(listenerM_cord(2)+[-1.5 1.5]);
        ...
        myVideo = VideoWriter([expdir '/' exp '/fmri/animation/' rname '_tr_pattern_binSize' num2str(binSize) '_mds_' type '_2d_focused_'  num2str(tr_s) '-' num2str(tr_e)  'TR.avi']);
