function roi_temporal_lagcorr_SL_g
...
for ei=1:4;
   ...
   % mkdir([expdir '/' exp '/fmri/temporal/lagcorr/' timeUnit '/roi/' froidir '/SL_g/perm/']);
    ...
    for lagi=1:1:length(lags_tested);
        ...
        save([expdir '/' exp '/fmri/temporal/lagcorr/' timeUnit '/roi/' froidir '/SL_g/lag' num2str(min(lags)) '-' num2str(max(lags)) ],'r','lags','rnames','keptT');
        clear r
    end
end
