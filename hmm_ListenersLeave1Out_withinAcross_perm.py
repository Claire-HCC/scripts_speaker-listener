...
# load mat file
fnames=glob.glob(os.path.join(expdir + '/' + exp + '/fmri/timeseries/' + timeUnit + '/network/' + froidir , 'zscore_listenerAll_*.mat'))
rname=re.search('/scratch/claire/speaker-listener//' + exp + '/fmri/timeseries/tr/network/mor/zscore_listenerAll_(.+?).mat', fnames[ri-1]).group(1) 
