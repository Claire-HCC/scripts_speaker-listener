function network2networks_temporal_circularlagcorr_LL_leave1out_timeReversed
...
for ei=2;%[1 2 6];%:10;
    ...
    for sdi=1:length(networks);
        ...
        save([expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/network2networks/' froidir '/LL_leave1out/' seed '_timeReversed'  ],'r','networks','keptT');
    end
