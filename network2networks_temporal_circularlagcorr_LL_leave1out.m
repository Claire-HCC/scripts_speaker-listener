function network2networks_temporal_circularlagcorr_LL_leave1out
...
for ei=2;%2:10;
    ...
    for sdi=1:length(networks);
        ...
        save([expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/network2networks/' froidir '/LL_leave1out/' seed  '' ],'r','networks','keptT');
    end
end
