function roi_tr_temporal_regression_SL
...
for ei=3;%2:4;
    ...
    for lagi=1:length(lags_tested);
        ...
        save([expdir '/' exp '/fmri/temporal_regression/' timeUnit '/roi/' froidir '/SLg/regression_SL_lag' num2str(min(lags)) '-' num2str(max(lags)) ],'b','F','r2','p','lags','rnames','keptT','r2_byTime');
