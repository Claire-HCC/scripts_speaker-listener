...
for ei=3;%1:4;
    ...
    save([expdir '/' exp '/fmri/pattern_regression_bined/' timeUnit '/roi/' froidir '/granger_SL_event_lag' num2str(min(lags)) '-' num2str(max(lags)) ],'b_l','b_ls','b_s','F_l','r2_l','p_ls','F_ls','r2_ls','p_ls','F_s','r2_s','p_s','F_s2l','F_l2l','eventLabels_LG_kept','rnames');
