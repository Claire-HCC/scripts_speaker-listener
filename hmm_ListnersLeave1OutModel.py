...
fname=expdir+ exp + "/fmri/timeseries/tr/network/mor/zscore_listenerAll_iscmasked_" + rname +".mat"
...
np.savez(expdir +  exp+ '/fmri/hmm/ListenersLeave1Out_eventLabels/'+ rname + '_ListenersLeave1Out_eventLabels_K' +str(K)+ '.npz', eventLabels_others=eventLabels_others,eventLabels_self=eventLabels_self) 
