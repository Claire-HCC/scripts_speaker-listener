...
for ei=1:length(eis);
    ...
    load([expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/roi2vox/' froidir '/LL_leave1out/'  roi '.mat'   ],'r','keptvox','keptT');
    rzm=nanmean(atanh(r),3);
    
    load([expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/roi2vox/'  froidir '/LL_leave1out/' roi '_timeReversed.mat'   ],'r','keptT');
...
save([expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/roi2vox/' froidir  '/LL_leave1out/' roi '2voxIsc' num2str(perc*100) 'PercMasked_lag' num2str(min(lags)) '-' num2str(max(lags)) '_timeReverse_fdr_peakLags.mat' ],...
...
% mat(keptvox)=sig;
% nii=mat2nii(mat);
% save_nii(nii,[expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/roi2vox/' froidir '/LL_leave1out/' roi '2voxIsc' num2str(perc*100) 'PercMasked_lag' num2str(min(lags)) '-' num2str(max(lags)) '_timeReversed_pfdr_mask.nii' ]);
%
%
% mat=nan(voxn,1);
% mat(keptvox(sig))=peaks(sig);
% nii=mat2nii(mat);
% save_nii(nii,[expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/roi2vox/' froidir '/LL_leave1out/' roi '2voxIsc' num2str(perc*100) 'PercMasked_lag' num2str(min(lags)) '-' num2str(max(lags)) '_timeReversed_fdr_peaks.nii' ]);
%
% mat=nan(voxn,1);
% mat(keptvox)=peaks;
% nii=mat2nii(mat);
% save_nii(nii,[expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/roi2vox/' froidir '/LL_leave1out/' roi '2voxIsc' num2str(perc*100) 'PercMasked_lag' num2str(min(lags)) '-' num2str(max(lags)) '_timeReversed_peaks.nii' ]);
%
%
mat=nan(voxn,1);
mat(keptvox)=peakLags;
nii=mat2nii(mat);
save_nii(nii,[expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/roi2vox/' froidir '/LL_leave1out/' roi '2voxIsc' num2str(perc*100) 'PercMasked_lag' num2str(min(lags)) '-' num2str(max(lags)) '_timeReverse_peakLags.nii' ])

% mat=nan(voxn,1);
% mat(keptvox(sig))=peakLags(sig);
% nii=mat2nii(mat);
% save_nii(nii,[expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/roi2vox/' froidir '/LL_leave1out/' roi '2voxIsc' num2str(perc*100) 'PercMasked_lag' num2str(min(lags)) '-' num2str(max(lags)) '_timeReverse_fdr_peakLags.nii' ])
%
%  peakLags_bined=discretize(peakLags,[-15 -10 -6 -3 0 1 4  7  11 16]);
% mat=nan(voxn,1);
% mat(keptvox)=peakLags_bined;
% nii=mat2nii(mat);
% save_nii(nii,[expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/roi2vox/' froidir '/LL_leave1out/' roi '2voxIsc' num2str(perc*100) 'PercMasked_lag' num2str(min(lags)) '-' num2str(max(lags)) '_timeReversed_peakLagsBined.nii' ]);

peakLags_bined=discretize(peakLags,[-15 -1 0 1 2 16]);
mat=nan(voxn,1);
mat(keptvox)=peakLags_bined;
nii=mat2nii(mat);
save_nii(nii,[expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/roi2vox/' froidir '/LL_leave1out/' roi '2voxIsc' num2str(perc*100) 'PercMasked_lag' num2str(min(lags)) '-' num2str(max(lags)) '_timeReversed_peakLags5bins.nii' ]);

mat(keptvox(sig==0))=NaN;;
nii=mat2nii(mat);
save_nii(nii,[expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/roi2vox/' froidir '/LL_leave1out/' roi '2voxIsc' num2str(perc*100) 'PercMasked_lag' num2str(min(lags)) '-' num2str(max(lags)) '_timeReversed_pfdr_peakLags5bins.nii' ]);

peakLags_bined=discretize(peakLags,[-15 -1 0 1 2 16]);
mat=nan(voxn,1);
mat(keptvox(abs(npeaks)<peaks | isnan(npeaks)))=peakLags_bined(abs(npeaks)<peaks | isnan(npeaks));
nii=mat2nii(mat);
save_nii(nii,[expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/roi2vox/' froidir '/LL_leave1out/' roi '2voxIsc' num2str(perc*100) 'PercMasked_lag' num2str(min(lags)) '-' num2str(max(lags)) '_timeReversed_maxpos_peakLags5bins.nii' ]);
