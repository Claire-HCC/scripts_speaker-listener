function network2networks_temporal_circularlagcorr_LL_selfself
...
for ei=2:10;
    ...
    for sdi=1:length(networks);
        ...
        save([expdir '/' exp '/fmri/temporal/circularlagcorr/' timeUnit '/network2networks/' froidir '/LL_selfself/' seed  '' ],'r','networks','keptT');
    end
end
