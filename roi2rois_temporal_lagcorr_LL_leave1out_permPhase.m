function roi2rois_temporal_lagcorr_LL_leave1out_permPhase(ri)
...
for ei=[1 2 4];
    ...
    for lagi=1%:length(lags_tested);
        ...
        for sdi=2;%1:length(seeds);
            ...
            save([expdir '/' exp '/fmri/temporal/lagcorr/' timeUnit '/roi2rois/' froidir '/LL_leave1out/perm/' seed '_lag' num2str(min(lags)) '-' num2str(max(lags))  '_permPhase_' rname],'r','lags','keptT');
        end
    end
end
