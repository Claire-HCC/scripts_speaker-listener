function []=lag_ridgeregression_vox_perm(SLURM_ARRAY_JOB_ID)
%%%%% rerun because now we use zscore_leave !!!!!
%%
...
for ei=1%:2;
   ...
   %     B_sl=zeros(voxn,length(lags),params.iterations_PerPiece);
        ...
        for si=1:length(subjects);
            ...
            load([expdir exp '/fmri/mat/wholeBrain//leave1out/zscore_leave_' subj ]);
            ...
            for iti=1:params.iterations_PerPiece;
                ...
                listener_self_perm = phase_rand(x, params.permute)';
