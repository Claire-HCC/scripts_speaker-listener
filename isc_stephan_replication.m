...
for ei=2%:2;
    ...
    isc_sl_peakR=zeros(size(epi_s,1),1,length(subjects));
    isc_sl_peakT=zeros(size(epi_s,1),1,length(subjects));
...
save([expdir exp '/fmri/mat/wholeBrain/' exp '_isc_' role '_peakR.mat' ],'isc_peakR');
save([expdir exp '/fmri/mat/wholeBrain/' exp '_isc_' role '_peakT.mat' ],'isc_peakT');
