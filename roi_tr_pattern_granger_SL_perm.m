...
for ei=[3];%1:2;
    ...
    save([expdir '/' exp '/fmri/pattern_regression/' timeUnit '/roi/' froidir '/granger_SL_lag' num2str(min(lags)) '-' num2str(max(lags)) '_perm' num2str(perm)],'F_s2l','lags','rnames','keptT',...
