function roi_tr_pattern_lagcorr_SL_g
...
for ei=1:2;
    ...
    for lagi=1:length(lags_tested);
     ...
     %   mkdir([expdir '/' exp '/fmri/pattern/lagcorr/' timeUnit '/roi/' froidir '/SL_g/']);
        save([expdir '/' exp '/fmri/pattern/lagcorr/' timeUnit '/roi/' froidir '/SL_g/lag' num2str(min(lags)) '-' num2str(max(lags)) ],'r','lags','rnames','keptT');
        clear x y r
    end
end
